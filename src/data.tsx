...
export const posts = [
  {
    id: "1",
    caption: "Enjoying a beautiful sunset at the beach! 🌅 #BeachVibes",
    account: "TravelLover",
    views: 1500,
    comments: 45,
  ...
  },
  {
    id: "2",
    caption:
      "Just launched our new product! Check it out at our website. 🚀 #NewProduct",
    account: "TechStartup",
    views: 3000,
    comments: 120,
  ...
  },
  {
    id: "3",
    caption:
      "Excited to announce our upcoming webinar on digital marketing trends! Register now! 📊 #DigitalMarketing",
    account: "MarketingGuru",
    views: 2500,
    comments: 80,
  ...
  },
  {
    id: "4",
    caption:
      "New vlog is up! Come along with me as I explore Tokyo! 🗼 #TravelVlog",
    account: "AdventureSeeker",
    views: 5000,
    comments: 200,
  ...
  },
  {
    id: "5",
    caption:
      "Sharing our latest blog post on sustainable living. Small changes can make a big difference! 🌿 #Sustainability",
    account: "EcoWarrior",
    views: 1800,
    comments: 60,
